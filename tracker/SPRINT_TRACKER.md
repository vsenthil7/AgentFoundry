...
- **Backend engine:** 1128 tests passing · **100%** lines / branches / functions / statements (S114 added the /marketplace route; was 1124)
- **Web component (jsdom):** 298 tests passing · every screen module incl. compliance/ComplianceScreen.tsx + status/StatusHistoryScreen.tsx + governance/DataGovernanceScreen.tsx + marketplace/MarketplaceScreen.tsx at **100%** all four metrics; App.tsx 100% stmts/funcs/lines (branch 77% — defensive UI ternaries, see KNOWN_GAPS §2)
