...
- **Backend engine:** 1137 tests passing · **100%** lines / branches / functions / statements (S115 added the secrets write-path; was 1128)
- **Web component (jsdom):** 312 tests passing · every screen module incl. compliance/ComplianceScreen.tsx + status/StatusHistoryScreen.tsx + governance/DataGovernanceScreen.tsx + marketplace/MarketplaceScreen.tsx + secrets/SecretsScreen.tsx at **100%** all four metrics; App.tsx 100% stmts/funcs/lines (branch 77% — defensive UI ternaries, see KNOWN_GAPS §2)
