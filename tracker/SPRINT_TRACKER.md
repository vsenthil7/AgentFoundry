...
- **Backend engine:** 1116 tests passing · **100%** lines / branches / functions / statements (S107 added the billing/invoices read surface; was 1111)
- **Web component (jsdom):** 238 tests passing · ui/components.tsx + ui/AppShell.tsx + AuthedApp.tsx + auth/AuthGate.tsx + auth/authClient.ts + auth/AdminConsole.tsx + profile/ProfileScreen.tsx + admin/UsersScreen.tsx + platform/PlatformScreen.tsx + reviews/ReviewInbox.tsx + dashboard/HealthDashboard.tsx + secrets/SecretsScreen.tsx + billing/BillingScreen.tsx at **100%** all four metrics; App.tsx 100% stmts/funcs/lines (branch 77% — defensive UI ternaries, see KNOWN_GAPS §2)
- **Web build:** production build succeeds (69 modules)
