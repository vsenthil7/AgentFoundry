...
- **Web component (jsdom):** 97 tests passing · ui/components.tsx + ui/AppShell.tsx + auth/AuthGate.tsx at **100%** all four metrics; authClient.ts, AdminConsole.tsx at **100%** lines/branches; App.tsx 100% stmts/funcs/lines (branch 77% — defensive UI ternaries, see KNOWN_GAPS §2)
- **Web build:** production build succeeds (50 modules)
