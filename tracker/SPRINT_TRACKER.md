...
- **Backend engine:** 1111 tests passing · **100%** lines / branches / functions / statements (S106 added the secrets/connectors read surface; was 1106)
- **Web component (jsdom):** 225 tests passing · ui/components.tsx + ui/AppShell.tsx + AuthedApp.tsx + auth/AuthGate.tsx + auth/authClient.ts + auth/AdminConsole.tsx + profile/ProfileScreen.tsx + admin/UsersScreen.tsx + platform/PlatformScreen.tsx + reviews/ReviewInbox.tsx + dashboard/HealthDashboard.tsx + secrets/SecretsScreen.tsx at **100%** all four metrics; App.tsx 100% stmts/funcs/lines (branch 77% — defensive UI ternaries, see KNOWN_GAPS §2)
- **Web build:** production build succeeds (67 modules)
