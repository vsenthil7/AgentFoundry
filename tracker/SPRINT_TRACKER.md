...
- **Web component (jsdom):** 112 tests passing · ui/components.tsx + ui/AppShell.tsx + auth/AuthGate.tsx + auth/authClient.ts + profile/ProfileScreen.tsx at **100%** all four metrics; AdminConsole.tsx at **100%** lines/branches; App.tsx 100% stmts/funcs/lines (branch 77% — defensive UI ternaries, see KNOWN_GAPS §2)
- **Web build:** production build succeeds (51 modules)
