...
- **Web component (jsdom):** 269 tests passing · every screen module incl. sla/SlaScreen.tsx + compliance/ComplianceScreen.tsx at **100%** all four metrics; App.tsx 100% stmts/funcs/lines (branch 77% — defensive UI ternaries, see KNOWN_GAPS §2)
- **Web build:** production build succeeds (73 modules)
